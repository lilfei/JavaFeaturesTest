...
public class Analyze {
	...
	private static String getHouseInfo(String targetStr) {
		...
		Pattern pattern1 = Pattern.compile("fcg\">\\w*.+\\s*<dd>\\w*.+</dd>");
		Matcher matcher1 = pattern1.matcher(targetStr);
		String info = "";
		while (matcher1.find()) {
			info = matcher1.group(); // 提取出的片段
			Pattern pattern2 = Pattern.compile("f24 fcr\">[0-9]+");
			...
			Pattern pattern3 = Pattern.compile("房屋类型：</dt>\\s*<dd>[\\u4e00-\\u9fa5]+( *[\\u4e00-\\u9fa5]+)*");
			...
			// 建筑类型同理
			Pattern pattern4 = Pattern.compile("建筑类型：</dt>\\s*<dd>[\\u4e00-\\u9fa5]+( *[\\u4e00-\\u9fa5]+)*");
			...
			// 建筑年代
			Pattern pattern5 = Pattern.compile("建筑年代：</dt>\\s*<dd>[0-9]+");
			...
			// 容积率
			Pattern pattern6 = Pattern.compile("容积率：</dt>\\s*<dd>[0-9]+\\.[0-9]+");
			...
			// 物业费
			Pattern pattern9 = Pattern.compile("物业费：</dt>\\s*<dd>[0-9]+\\.[0-9]+");
			...
			// 物业公司
			Pattern pattern7 = Pattern.compile("物业公司：</dt>\\s*<dd>[\\u4e00-\\u9fa5]+( *[\\u4e00-\\u9fa5]+)*");
