...
public class DimensTool {
	...
	/** 源文件 单位统一px */
	static String oldFilePath = "D:/dimens.xml"; // 1920*1080
	/** 新生成文件路径 */
	...
	/** 缩小倍数 */
	// 参数设定
	static double change811 = 300d / 225d;
	static double change720 = 300d / 198d; // 除数
	static double change540 = 300d / 148d;
	static double change480 = 300d / 130d;
